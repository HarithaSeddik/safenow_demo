...
import 'package:safenow_demo/screens/onboarding_screen/views/otp_view/notifier/otp_view_notifier.dart';
...
class OtpView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final userPhoneNumber = ref.watch(phoneInputViewProvider).userPhoneNumber;
    return SizedBox(
